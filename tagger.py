...
if __name__ == "__main__":
    ...
    etreedb = SQLiteEtreeDB(
        r"db/etree_scrape.db"
    )  # make sure this is outside the loop called in the below function
    concert_folders = []
    ...
    ConcertTagger.tag_shows_debug(
        concert_folders, etreedb, config, clear_existing_tags=True
    )
